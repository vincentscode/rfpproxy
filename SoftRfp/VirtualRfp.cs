...
using RfpProxyLib;
using RfpCapabilities = RfpProxy.AaMiDe.AaMiDe.Sys.SysInitMessage.RfpCapabilities;
...
partial class VirtualRfp
{
    ...
    private async Task StartEncryptionAsync(CancellationToken cancellationToken)
    {
        ...
        _decipher = new BlowFish(_rfpa.Span[..56]);
        _encipher = new BlowFish(_rfpa.Span[8..]);
